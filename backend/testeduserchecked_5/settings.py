"""
Django settings for testeduserchecked_5 project.
...
ROOT_URLCONF = 'testeduserchecked_5.urls'
...
WSGI_APPLICATION = 'testeduserchecked_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testeduserchecked_5 API",
    "DESCRIPTION": "API documentation for testeduserchecked_5 App",
    "VERSION": "v1",
}
